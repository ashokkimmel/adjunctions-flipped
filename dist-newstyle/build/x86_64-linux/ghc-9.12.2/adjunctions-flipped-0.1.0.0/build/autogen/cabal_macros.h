...
/* package adjunctions-flipped-0.1.0.0 */
#ifndef VERSION_adjunctions_flipped
#define VERSION_adjunctions_flipped "0.1.0.0"
#endif /* VERSION_adjunctions_flipped */
#ifndef MIN_VERSION_adjunctions_flipped
#define MIN_VERSION_adjunctions_flipped(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_adjunctions_flipped */
...
#define CURRENT_PACKAGE_KEY "adjunctions-flipped-0.1.0.0-inplace"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "adjunctions-flipped-0.1.0.0-inplace"

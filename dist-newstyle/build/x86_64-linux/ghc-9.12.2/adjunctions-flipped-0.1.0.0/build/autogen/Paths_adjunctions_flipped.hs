...
{-|
Module      : Paths_adjunctions_flipped
...
-- at runtime using the environment variable adjunctions_flipped_bindir.
...
-- environment variable adjunctions_flipped_libdir.
...
-- using the environment variable adjunctions_flipped_dynlibdir.
...
-- runtime using the environment variable adjunctions_flipped_datadir.
...
-- variable adjunctions_flipped_libexedir.
...
-- using the environment variable adjunctions_flipped_sysconfdir.
...
libdir     = "/home/runner/.cabal/lib/x86_64-linux-ghc-9.12.2-9b33/adjunctions-flipped-0.1.0.0-inplace"
dynlibdir  = "/home/runner/.cabal/lib/x86_64-linux-ghc-9.12.2-9b33"
datadir    = "/home/runner/.cabal/share/x86_64-linux-ghc-9.12.2-9b33/adjunctions-flipped-0.1.0.0"
libexecdir = "/home/runner/.cabal/libexec/x86_64-linux-ghc-9.12.2-9b33/adjunctions-flipped-0.1.0.0"
sysconfdir = "/home/runner/.cabal/etc"

getBinDir     = catchIO (getEnv "adjunctions_flipped_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "adjunctions_flipped_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "adjunctions_flipped_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "adjunctions_flipped_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "adjunctions_flipped_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "adjunctions_flipped_sysconfdir") (\_ -> return sysconfdir)
